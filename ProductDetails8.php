...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="shoe2.png" class="d-block w-100" alt="First slide">
    </div>
    <div class="carousel-item">
      <img src="shoe2.png" class="d-block w-100" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img src="shoe2.png" class="d-block w-100" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img src="shoe2.png" class="d-block w-100" alt="Third slide">
    </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
			...
			<div class="col-md-7">
				...
				<p class="price">INR Rs.1000</p>
				<p><b>Availability:</b> In Stock</p>
				<p><b>Condition:</b >New</p>
				<p><b>Brand:</b> XYZ Company</p>

				<form action="ProductDetails8.php" method="post">
					
					<input type="hidden" name="Product-Name" value="Fancy Shoes">
					<label>Quantity:</label>
				<input type="number" name="Quantity"  min="1" max="10" value="1" >
					<input type="hidden" name="ProductID" value="2">
					<input type="hidden" name="Product-price" value="1000">
					<br>
					<br>
