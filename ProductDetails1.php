...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="clothes1.png" class="d-block w-100" alt="First slide">
    </div>
    <div class="carousel-item">
      <img src="clothes1.png" class="d-block w-100" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img src="clothes1.png" class="d-block w-100" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img src="clothes1.png" class="d-block w-100" alt="Third slide">
    </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
			...
			<div class="col-md-7">
				...
				<div class="addtocart">
				<form action="ProductDetails1.php" method="post">
					
					<input type="hidden" name="Product-Name" value="Designer Jeans">
					<label>Quantity:</label>
				<input type="number" name="Quantity"  min="1" max="10" value="1" >
					<input type="hidden" name="ProductID" value="4">
					<input type="hidden" name="Product-price" value="999">
			    	<br>
			    	<br>
