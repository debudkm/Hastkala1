...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="handmade2.png" class="d-block w-100" alt="First slide">
    </div>
    <div class="carousel-item">
      <img src="handmade2.png" class="d-block w-100" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img src="handmade2.png" class="d-block w-100" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img src="handmade2.png" class="d-block w-100" alt="Third slide">
    </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
			...
			<div class="col-md-7">
				...
				<form action="ProductDetails4.php" method="post">
					
					<input type="hidden" name="Product-Name" value="Baskets">
